...
namespace TestModule
{
    public class Adapter
    {
        ...
        public static async Task<Adapter> CreateAsync(TypeOfAdapter type, string path)
        {
            var adapter = new Adapter(type, path);
            await Task.Run(() => {
            });
            return adapter;
        }

        private async Task FormsExecute(string path)
        {
            DataForForms data = new DataForForms(path);
    ...
    public class DataForForms
    {
        ...
        public DataForForms(string reader)
        {
            Reader = reader;
        }
