...
internal class Program
{
    ...
    private static void StartNewTest()
    {
        ...
        // Получить файл
        // Превратить фрагменты в прмоугольники / полигоны

        // Отсеить лишние элементы (EntitiesObjsect)

        // Создание рамки + копирование документа
        // Получить EntityObject + Line
        // Собрать фигуру + Понять что это

        // Добавить второй вариант фигуры (полигонизированная / упрощенная до прямоугольника)
